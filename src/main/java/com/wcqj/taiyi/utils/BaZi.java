...
public class BaZi {
   ...
   public final static String[] Zhi = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"};
    ...
    public static final String[] nayin={
            ...
            "山头火","山头火","涧下水","涧下水","城墙土","城墙土","白腊金","白腊金","杨柳木","杨柳木",
 ...
 */
    final public String animalsYear() {
    	...
    	Date[] dateList  = Lunar.jieqilist(y);
    	Date curr = cal.getTime();
    	
    	int index = dateList.length;
		for(int i=0;i<dateList.length;i++){
			if( curr.before( dateList[i]) ){
				index = i - 1;
				break;
			}
		}
		...
		//未立春算去年的;
		if( index < 2) {
			return animalsYearFix( y - 1);
		}else {
			return animalsYearFix( y );
		}
    }
     ...
     * @return 传回农历 y年的生肖
     */
        final private String animalsYearFix(int year) {
...
//offset小于0时，也要校正
    ...
    public static void main(String[] args){
        ...
        try {
                ...
                cal.setTime(sdf.parse("2018-02-04 13:00"));
